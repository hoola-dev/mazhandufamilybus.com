...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice('Sub Agents','Below is a list of all Sub Agents of the selected Super Agent');  
	?>
    <div>Supr Agent Name: <?php echo $tpl['super_agent_detail']['name']; ?></div>
    <div style="margin-bottom:20px;">Supr Agent Email: <?php echo $tpl['super_agent_detail']['email']; ?></div>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left r5">
			<input type="hidden" name="controller" value="pjAdminAppUsers" />
