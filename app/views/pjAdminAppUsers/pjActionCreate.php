...
if (isset($tpl['status']))
{
	...
	?>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAppUsers&amp;action=pjActionCreate" method="post" id="frmCreateUser" class="form pj-form" autocomplete="off">
