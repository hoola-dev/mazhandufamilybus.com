...
if (isset($tpl['status']))
{
	...
	?>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAppUsers&amp;action=pjActionUpdate" method="post" id="frmUpdateUser" class="form pj-form">
		<input type="hidden" name="user_update" value="1" />
		<input type="hidden" name="id" value="<?php echo (int) $tpl['arr']['id']; ?>" />
		<input type="hidden" name="idExtra" value="<?php echo (int) $tpl['arrExtra']['id']; ?>" />
		<p>
			...
			if ((int) $tpl['arr']['id'] !== 1)
			{
				...
				<span class="inline_block">
					<select disabled ="disabled" name="role_id" id="role_id" class="pj-form-field required" onchange="javascript:show_hide_agent_type();">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input readonly ="readonly" type="text" name="email" id="email" class="pj-form-field required email w200" value="<?php echo pjSanitize::html($tpl['arr']['email']); ?>" />
			</span>
		</p>
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input readonly ="readonly" type="password" name="password" id="password" class="pj-form-field w200" value="<?php echo pjSanitize::html($tpl['arr']['password']); ?>" />
			</span>
		</p>
		<p>
			<label class="title">Title</label>
			<span class="inline_block">
				<select name="title" id="title" class="pj-form-field required">
					<option value="">-- <?php __('lblChoose'); ?>--</option>
					<option value="mr" <?php if($tpl['arrExtra']['title'] == 'mr'){ echo ' selected="selected"';}?>>Mr.</option>
					<option value="mrs" <?php if($tpl['arrExtra']['title'] == 'mrs'){ echo ' selected="selected"';}?>>Mrs.</option>
					<option value="ms" <?php if($tpl['arrExtra']['title'] == 'ms'){ echo ' selected="selected"';}?>>Ms.</option>
					<option value="dr" <?php if($tpl['arrExtra']['title'] == 'dr'){ echo ' selected="selected"';}?>>Dr.</option>
					<option value="prof" <?php if($tpl['arrExtra']['title'] == 'prof'){ echo ' selected="selected"';}?>>Prof.</option>
					<option value="rev" <?php if($tpl['arrExtra']['title'] == 'rev'){ echo ' selected="selected"';}?>>Rev.</option>
					<option value="other" <?php if($tpl['arrExtra']['title'] == 'other'){ echo ' selected="selected"';}?>>Other</option>
				</select>
			</span>
		</p>
		<p>
			...
			<span class="inline_block">
				<input type="text" name="first_name" id="name" value="<?php echo pjSanitize::html($tpl['arrExtra']['first_name']); ?>" class="pj-form-field w250 required" />
			</span>
		</p>
		<p>
			<label class="title">Last Name</label>
			<span class="inline_block">
				<input type="text" name="last_name" id="lname" value="<?php echo pjSanitize::html($tpl['arrExtra']['last_name']); ?>" class="pj-form-field w250 required" />
			</span>
		</p>
		<p>
			<label class="title"><?php __('lblPhone'); ?></label>
			<span class="inline_block">
				<input readonly ="readonly" type="text" name="phone" id="phone" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['phone'])); ?>" class="pj-form-field w250" />
			</span>
		</p>
        <p>
