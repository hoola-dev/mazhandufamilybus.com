													...
													if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'email') > -1))
													{
														...
														<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
															<td width="35%" valign="top">
                                                                <?php if ($tpl['arr'][$i]['key'] == 'o_email_cash_notify_message') { ?>
                                                                    <span class="block bold">Email confirmation sent after Cash Booking</span>																
                                                                <?php } if ($tpl['arr'][$i]['key'] == 'o_email_cash_cancel_message') { ?>
                                                                    <span class="block bold">Seats pending time expired Email message for Cash Booking</span>
                                                                <?php } else if ($tpl['arr'][$i]['key'] == 'o_email_pending_subject') { ?>
                                                                    <span class="block bold">Pending Email subject</span>
                                                                <?php } else if ($tpl['arr'][$i]['key'] == 'o_email_pending_message') { ?>
                                                                    <span class="block bold">Pending Email message</span>                                                                
                                                                <?php } else { ?>
															...
															<td valign="top">
																...
																{
																	case 'string':
																		if(in_array($tpl['arr'][$i]['key'], array('o_email_confirmation_subject','o_email_payment_subject','o_email_notify_subject','o_email_cancel_subject','o_email_pending_subject')))
																		{
																		?>
																			<?php
																				foreach ($tpl['lp_arr'] as $v)
																	...
																	case 'text':
																		...
																		if(in_array($tpl['arr'][$i]['key'], array('o_email_confirmation_message','o_email_payment_message','o_email_notify_message','o_email_cancel_message','o_email_cash_notify_message','o_email_cash_cancel_message','o_email_pending_message')))
																		{
																		?>
																			<?php
																				foreach ($tpl['lp_arr'] as $v)
											...
											<tbody>
												...
												for ($i = 0; $i < $count; $i++)
												{
													if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'sms') > -1))
													{
														...
														<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
															<td width="35%" valign="top">                                                            
                                                            <?php if ($tpl['arr'][$i]['key'] == 'o_sms_cash_notify_message') { ?>
                                                                <span class="block bold">SMS confirmation sent after Cash Booking</span>																
                                                            <?php } if ($tpl['arr'][$i]['key'] == 'o_sms_cash_cancel_message') { ?>
                                                                <span class="block bold">Seats pending time expired SMS message for Cash Booking</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_pending_message') { ?>
                                                                <span class="block bold">Pending SMS message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_notify_message') { ?>
                                                                <span class="block bold">Seats pending time expired SMS message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_site_notify_message') { ?>
                                                                <span class="block bold">Pending Site message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_wallet_site_notify_message') { ?>
                                                                <span class="block bold">Pending Wallet Site message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_wallet_site_failed_message') { ?>
                                                                <span class="block bold">Failed Wallet Request Message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_cgrate_site_failed_message') { ?>
                                                                <span class="block bold">Failed cGrate Message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_cgrate_site_success_message') { ?>
                                                                <span class="block bold">Success cGrate Message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_wallet_failed_message') { ?>
                                                                <span class="block bold">Failed Wallet Message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_site_common_notify_message') { ?>
                                                                <span class="block bold">Success Site message</span>
                                                            <?php } else if ($tpl['arr'][$i]['key'] == 'o_sms_cancel_message') { ?>
                                                                <span class="block bold">Cancel SMS message</span>
                                                            <?php } else { ?>
																<span class="block bold"><?php __('opt_' . $tpl['arr'][$i]['key']); ?></span>
																<span class="fs10"><?php nl2br(__('opt_' . $tpl['arr'][$i]['key'].'_text')); ?></span>
															<?php } ?>
															...
															<td valign="top">
																...
																switch ($tpl['arr'][$i]['type'])
																{
																	...
																	case 'text':
																		...
																		if(in_array($tpl['arr'][$i]['key'], array('o_sms_confirmation_message','o_sms_payment_message','o_sms_cancel_message','o_sms_cash_notify_message','o_sms_cash_cancel_message','o_sms_pending_message','o_sms_notify_message','o_sms_site_notify_message','o_sms_wallet_site_notify_message','o_sms_wallet_site_failed_message','o_sms_wallet_failed_message','o_sms_site_common_notify_message','o_sms_cancel_message','o_sms_cgrate_site_failed_message','o_sms_cgrate_site_success_message')))
																		{
																		?>
																			<?php
																				foreach ($tpl['lp_arr'] as $v)
                                    ...
                                    <fieldset class="fieldset white">
										...
										<table class="pj-table" cellpadding="0" cellspacing="0" style="width: 100%">
											...
											<tbody>
												...
												for ($i = 0; $i < $count; $i++)
												{
													if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'api') > -1))
													{
														...
														<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
															<td width="35%" valign="top">  
                                                            <?php if ($tpl['arr'][$i]['key'] == 'o_api_cash_notify_message') { ?>
                                                                <span class="block bold">Pending API message</span>
                                                            <?php } else { ?>
																<span class="block bold"><?php __('opt_' . $tpl['arr'][$i]['key']); ?></span>
																<span class="fs10"><?php nl2br(__('opt_' . $tpl['arr'][$i]['key'].'_text')); ?></span>
															<?php } ?>
															...
															<td valign="top">
																...
																switch ($tpl['arr'][$i]['type'])
																{
																	...
																	case 'text':
																		...
																		if(in_array($tpl['arr'][$i]['key'], array('o_api_cash_notify_message')))
																		{
																		?>
																			<?php
																				foreach ($tpl['lp_arr'] as $v)
