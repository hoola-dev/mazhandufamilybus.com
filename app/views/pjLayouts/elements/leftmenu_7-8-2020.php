...
<div class="leftmenu-middle">    
	<ul class="menu">
        ...
        if ($controller->isAdmin() ||$controller->isBusAdmin() || $controller->isSuperAgent()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && ($_GET['action'] == 'pjActionIndex' || $_GET['action'] == 'pjActionCommission')) ? 'menu-focus' : NULL; ?>"><span class="menu-agentsrevenew">&nbsp;</span>Agents Revenue</a></li>
        <?php
        }
        ?>
        <?php
        ...
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionCreditAllocation" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && $_GET['action'] == 'pjActionCreditAllocation') ? 'menu-focus' : NULL; ?>"><span class="menu-agentsrevenew">&nbsp;</span>Credit Allocation</a></li>
        <?php
        }
        ?>
        <?php
        if ($controller->isAdmin() ||$controller->isBusAdmin() || $controller->isSuperAgent()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionGetCreditPassword" class="<?php echo $_GET['controller'] == 'pjAdmin' && $_GET['action'] == 'pjActionGetCreditPassword' ? 'menu-focus' : NULL; ?>"><span class="menu-getcreditpassword">&nbsp;</span>Get Credit Password</a></li>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionCreditPassword" class="<?php echo $_GET['controller'] == 'pjAdmin' && $_GET['action'] == 'pjActionCreditPassword' ? 'menu-focus' : NULL; ?>"><span class="menu-creditpassword">&nbsp;</span>Change Credit Password</a></li>
        <?php
        }
        ?>
        <?php
        ...
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionCommission&id=<?php echo $controller->getUserId(); ?>" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && $_GET['action'] == 'pjActionCommission') ? 'menu-focus' : NULL; ?>"><span class="menu-agentsrevenew">&nbsp;</span>My Revenue</a></li>
        <?php
        }
        ?>
