...
<?php
$my_text = ($controller->isBusAdmin() || $controller->isEditor()) ? 'My ' : '';
?>
...
<div class="leftmenu-middle">    
	<ul class="menu">
        ...
        <?php if ($controller->isAdmin() || $controller->isBusAdmin() || $controller->isEditor()) { ?>
        ...
        <?php } ?>
        <?php if ($controller->isBusAdmin() || $controller->isEditor()) { ?>
        ...
        <?php } ?>
        <?php
		if ($controller->isAdmin() || $controller->isBusAdmin() || $controller->isEditor()) {
		?>
        ...
        if ($controller->isAdmin() ||$controller->isBusAdmin() || $controller->isSuperAgent()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && ($_GET['action'] == 'pjActionIndex' || $_GET['action'] == 'pjActionCommission')) ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>Agents Revenue</a></li>
        <?php
        }
        ?>
        <?php
        ...
        if ($controller->isAdmin() ||$controller->isBusAdmin() || $controller->isSuperAgent()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionGetCreditPassword" class="<?php echo $_GET['controller'] == 'pjAdmin' && $_GET['action'] == 'pjActionGetCreditPassword' ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>Get Credit Password</a></li>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionCreditPassword" class="<?php echo $_GET['controller'] == 'pjAdmin' && $_GET['action'] == 'pjActionCreditPassword' ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>Change Credit Password</a></li>
        <?php
        }
        ?>
        <?php
        ...
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminNews&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminNews' ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>News</a></li>
        <?php
        }
        ?>
...
<div class="leftmenu-middle">    
	<ul class="menu mx--0">
        <li class="text--left">Welcome <?php echo $controller->getName(); ?></li>
        <li class="role--name"><?php echo $controller->getRoleName(); ?></li>
        <?php if ($controller->isAdmin() || $controller->isBusAdmin() || $controller->isEditor()) { ?>
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdmin' && $_GET['action'] == 'pjActionIndex' ? 'menu-focus' : NULL; ?>"><span class="menu-dashboard">&nbsp;</span><?php __('menuDashboard'); ?></a></li>
        <?php } ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSchedule&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminSchedule') ? 'menu-focus' : NULL; ?>"><span class="menu-schedule">&nbsp;</span><?php __('menuSchedule'); ?></a></li>
        ...
        if ($controller->isSuperAgent()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionCreditAllocation" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && $_GET['action'] == 'pjActionCreditAllocation') ? 'menu-focus' : NULL; ?>"><span class="menu-getcredit">&nbsp;</span>Credit Allocation</a></li>
        <?php
        }
        ?>
        <?php
        ...
        if ($controller->isEditor()) {
        ?>
        <li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminAgents&amp;action=pjActionCommission&id=<?php echo $controller->getUserId(); ?>" class="<?php echo ($_GET['controller'] == 'pjAdminAgents' && $_GET['action'] == 'pjActionCommission') ? 'menu-focus' : NULL; ?>"><span class="menu-revenue">&nbsp;</span>My Revenue</a></li>
        <?php
        }
        ?>
