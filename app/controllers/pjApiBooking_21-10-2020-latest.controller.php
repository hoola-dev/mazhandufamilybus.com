            ...
            if ($available_seats) {
                ...
                if(count($intersect) > 0) {
                    ...
                    if ($result['code'] == 200) {
                        ...
                        $return_data[$keyVal]['booking_id'] = $result['booking_id'];
                        $return_data[$keyVal]['user_id'] = $result['additional_data']['user_id'];
                        $return_data[$keyVal]['unique_id'] = $result['additional_data']['unique_id'];

                        $booking_date_arr = explode("/",  $booking_date);

                        $return_data[$keyVal]['travel_date'] = $booking_date_arr[0].'-'.$booking_date_arr[1].'-'.$booking_date_arr[2];
                        $return_data_name = strip_tags($result['additional_data']['name']);

                        $return_data_name_arr = explode(",", $return_data_name);
                        $return_data[$keyVal]['name'] = $return_data_name_arr[0];

                        $return_data[$keyVal]['status'] = $result['additional_data']['status'];
                        $return_data[$keyVal]['title'] = $person->title;
                        $return_data[$keyVal]['person_firstname'] = $result['additional_data']['person_firstname'];
                        $return_data[$keyVal]['person_lastname'] = $result['additional_data']['person_lastname'];
                        $return_data[$keyVal]['person_phone'] = $result['additional_data']['person_phone'];
                        $return_data[$keyVal]['person_email'] = $result['additional_data']['person_email'];
                        $return_data[$keyVal]['from_location_name'] = $result['additional_data']['from_location_name'];
                        $return_data[$keyVal]['to_location_name'] = $result['additional_data']['to_location_name'];
                        $return_data[$keyVal]['total_price'] = $result['additional_data']['total_price'];
                        //$return_data['total_no_of_seatsbooked'] = $result['additional_data']['total_no_of_seatsbooked'];
                        $return_data[$keyVal]['total_no_of_seatsbooked'] = $seats;

                        $return_data[$keyVal]['departure_time'] = $result['additional_data']['departure_time'];
                        $return_data[$keyVal]['arrival_time'] = $result['additional_data']['arrival_time'];
                        $return_data[$keyVal]['payment_mode'] = $result['additional_data']['payment_mode'];
                        $return_data[$keyVal]['group_identifier'] = $result['additional_data']['group_identifier'];

                        //for return trip in case of round trip
                        if(isset($is_return) && ($is_return == 'T')){
                            $return_data[$keyVal]['r_booking_id'] = $result['additional_data']['r_booking_id'];
                            $return_data[$keyVal]['r_unique_id'] = $result['additional_data']['r_unique_id'];

                            $return_date_arr = explode("/",  $return_date);
                            $return_date_formatted = $return_date_arr[0].'-'.$return_date_arr[1].'-'.$return_date_arr[2];
                            $return_data[$keyVal]['return_date'] = $return_date_formatted;
                            
                            $return_data_r_name = strip_tags($result['additional_data']['r_name']);
                            $return_data_r_name_arr = explode(",", $return_data_r_name);
                            $return_data[$keyVal]['r_name'] = $return_data_r_name_arr[0];
                            $return_data[$keyVal]['r_status'] = $result['additional_data']['r_status'];
                            $return_data[$keyVal]['r_from_location_name'] = $result['additional_data']['r_from_location_name'];
                            $return_data[$keyVal]['r_to_location_name'] = $result['additional_data']['r_to_location_name'];
                            $return_data[$keyVal]['r_total_price'] = $result['additional_data']['r_total_price'];
                            $return_data[$keyVal]['r_total_no_of_seatsbooked'] = $return_seats;
                            $return_data[$keyVal]['r_departure_time'] = $result['additional_data']['r_departure_time'];
                            $return_data[$keyVal]['r_arrival_time'] = $result['additional_data']['r_arrival_time'];
                            $return_data[$keyVal]['r_group_identifier'] = $result['additional_data']['r_group_identifier'];
