...
class pjApiAgents extends pjFront
{
    ...
    public function pjGetCreditData(){
        ...
        if($token_validation_result){
            ...
            echo "user_credit_balance:".$user_credit_balance."<br/>";

            $user_commission_percent = (!empty($user_credit)) ? $user_credit[0]['commission_percent'] : 0;

            echo "user_commission_percent:".$user_commission_percent."<br/>";
            $total_amount += $user_commission_percent;
            ...
            $data['total_allocated_credit'] = $total_amount;
