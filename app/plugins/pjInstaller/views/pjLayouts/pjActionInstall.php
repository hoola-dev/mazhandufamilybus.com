...
<html>
	...
	<body>
		<div id="container">
    		<div id="header">
				<a href="https://www.parezagroup.com/" id="logo" target="_blank"><img src="<?php echo pjObject::getConstant('pjInstaller', 'PLUGIN_IMG_PATH'); ?>install-logo.png" alt="Install Wizard" /></a>
			</div>
			<div id="middle">
