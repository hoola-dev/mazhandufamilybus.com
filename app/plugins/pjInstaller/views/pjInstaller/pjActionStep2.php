...
<div class="i-wrap">
	...
	?>
	<p>Enter your licence key. You can find your key under Profile page in your <a href="https://www.parezagroup.com/accounts/login" target="_blank">ParezaGroup.com account</a>.
	...
	<form action="index.php?controller=pjInstaller&amp;action=pjActionStep3&amp;install=1" method="post" id="frmStep2" class="i-form">
		...
		<div class="t20">
			<p class="float_left pt5">Need help? <a href="https://www.parezagroup.com/contact.php" target="_blank">Contact us</a></p>
