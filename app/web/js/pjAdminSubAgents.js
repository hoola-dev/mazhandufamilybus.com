	...
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var $grid = $("#grid").datagrid({
				...
				dataUrl: "index.php?controller=pjAdminUsers&action=pjActionGetSubAgent",
				dataType: "json",
		...
		$(document).on("click", ".btn-all", function (e) {
			...
			$grid.datagrid("load", "index.php?controller=pjAdminUsers&action=pjActionGetSubAgent", "name", "ASC", content.page, content.rowCount);
			return false;
			...
			$.post("index.php?controller=pjAdminUsers&action=pjActionSetActive", {
				...
				$grid.datagrid("load", "index.php?controller=pjAdminUsers&action=pjActionGetSubAgent");
			});
			return false;
			...
			$grid.datagrid("option", "cache", cache);
			$grid.datagrid("load", "index.php?controller=pjAdminUsers&action=pjActionGetSubAgent", "id", "ASC", content.page, content.rowCount);
			return false;
		});
	});
